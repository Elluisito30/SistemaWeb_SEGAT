...
<body class="login">
        <div class="logo">
            <img src="{{asset('/img/Logo_Segat.png')}}" alt="Sistema de Ventas & ABC">
        </div>
        <div class="content">                        
     
        <form method="POST" action="{{ route ('identificacion') }}">   <!-- Primera corrección -->                      
              @csrf  
        ...
        <div class="copyright">
            2025 &copy; Servicio de Gestión Ambiental de Trujillo (SEGAT)
        </div>
