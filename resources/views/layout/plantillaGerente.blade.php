    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="{{ route('gerente.trabajador.index')}}" class="nav-link">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="{{ route('gerente.reportes.solicitudes') }}" class="nav-link">
              ...
              <li class="nav-item">
                <a href="{{ route('gerente.reportes.infracciones') }}" class="nav-link">
