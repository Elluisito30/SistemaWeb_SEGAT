            ...
            <div class="card shadow-sm border-0">
                ...
                <div class="card-body p-4">
                    <div class="d-flex justify-content-between align-items-end mb-4">
                        <form method="GET" action="{{ route('trabajador.notificaciones.index') }}" class="w-100">
                            <div class="row g-2">
                                <div class="col-md-4">
                                    ...
                                    <tr class="shadow-sm" style="background-color: white;">
                                        <td>
                                            @php
                                                ...
                                                $config = $iconos[$notif->tipo] ?? $iconos['general'];
                                            @endphp
                                            <i class="fas {{ $config['icon'] }} text-{{ $config['color'] }} fa-2x"></i>
                                        </td>
